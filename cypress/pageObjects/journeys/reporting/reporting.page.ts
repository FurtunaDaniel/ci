class JourneyReporting {
  ...
  accountSearchPath = '**/accounts/playbookId?limit=10&offset=0&search=*'
  // fixtures
  ...
  accountListSearchFixture = 'reporting/accountListFiltered.json'
  // elements
...
export const journeyReporting = new JourneyReporting()
